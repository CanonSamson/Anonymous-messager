...
const LandingPage = () => {
    ...
    return (
        <div>
            <div className=" gap-5 grid grid-cols-2 justify-around  min-h-screen w-full items-center px-10">
                <div className=" flex flex-col gap-2">
                    <h1 className=" text-5xl font-semibold">Recieve anonymous compliments from your friends.</h1>
                    ...
                    <div className=" flex gap-2 text-[12px]">
                        <button
                            ...
                            className=" bg-blue-600 text-white w-[150px] py-3  rounded
                            active:scale-95 duration-75 ">
                            GET STARTED
                        </button>
                        <button
                            onClick={() => { setLoginPop(!loginPop) }}
                            className=" border-2 border-blue-600 text-black w-[150px] py-3
